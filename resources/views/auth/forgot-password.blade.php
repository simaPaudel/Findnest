...
<head>
    ...
    <title>Forgot Password - FindNest</title>
...
<body>
    <div class="relative z-10 w-full max-w-md px-6">
        ...
        <div class="text-center mb-8">
            ...
            <p class="mt-2" style="color: var(--fn-gray-dark); font-size: 15px;">Reset your password</p>
        </div>

        <!-- Forgot Password Card -->
        <div class="fn-glass-card p-8">
            <h2 class="text-2xl font-bold text-center mb-4" style="color: var(--fn-charcoal);">Forgot Password?</h2>
