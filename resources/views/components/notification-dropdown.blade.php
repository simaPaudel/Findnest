    ...
    <details class="fn-notification-menu">
        ...
        <div class="fn-notification-panel">
            ...
            <div class="fn-notification-header">
                ...
                @if($unreadCount > 0)
                    <form method="POST" action="{{ route('notifications.mark-all-read') }}" class="fn-notification-mark-all-form">
                        @csrf
            ...
            <div class="fn-notification-items">
                @forelse($notifications as $notification)
                    <a href="{{ route('notifications.open', $notification) }}" class="fn-notification-item {{ $notification->is_read ? '' : 'unread' }}">
                        @if(!$notification->is_read)
                            <div class="fn-unread-indicator"></div>
                        @endif
                        <div class="fn-notification-content">
                            <div class="fn-notification-title-line">
                                <h3 class="fn-notification-item-title">{{ $notification->title }}</h3>
                                <span class="fn-notification-item-time">{{ optional($notification->created_at)->diffForHumans() }}</span>
                            </div>
                            <p class="fn-notification-item-message">{{ \Illuminate\Support\Str::limit($notification->message, 100) }}</p>
                        </div>
                    </a>
                @empty
            ...
            <div class="fn-notification-footer">
                <a href="{{ route('notifications.index') }}" class="fn-see-all-link">
