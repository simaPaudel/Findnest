...
<body>
    ...
    <main class="py-10 lg:py-12">
        <div class="mx-auto max-w-7xl px-4 lg:px-6">
            <div class="space-y-8">
                <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center text-sm font-medium text-slate-500 transition hover:text-rose-600">
                    Back to Home
                </a>
                                ...
                                <div class="mt-5 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 inline-flex items-center rounded-full bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-600">
                                            Trust Points: <?php echo e((int) ($property->owner->trust_points ?? 0)); ?>
                    ...
                    <div class="space-y-8">
                        ...
                        <?php if($property->description): ?>
                            <section class="surface surface-section p-7">
                                ...
                                <p class="section-copy mt-4 whitespace-pre-line text-base leading-8"><?php echo e($property->description); ?></p>
                            </section>
                        <?php endif; ?>
                        ...
                        <?php if($property->rules): ?>
                            <section class="surface surface-section p-7">
                                ...
                                <p class="section-copy mt-4 whitespace-pre-line text-base leading-8"><?php echo e($property->rules); ?></p>
                            </section>
                        <?php endif; ?>
                    ...
                    <section class="space-y-6 border-t border-slate-200 pt-10">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
                            <?php $__currentLoopData = $similar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <a href="<?php echo e(route('listings.show', $p->id)); ?>" class="similar-card block overflow-hidden rounded-[22px] border border-slate-200 bg-white shadow-sm transition">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <p class="mt-2 flex items-center gap-1.5 text-sm text-slate-600">
                                            ...
                                            <?php if($similarReviewCount > 0): ?>
                                                <span><?php echo e(number_format($similarAverageRating, 1)); ?> · <?php echo e($similarReviewCount); ?> <?php echo e($similarReviewCount === 1 ? 'review' : 'reviews'); ?></span>
                                            <?php else: ?>
