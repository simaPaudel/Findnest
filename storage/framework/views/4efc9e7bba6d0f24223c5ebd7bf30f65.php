...
<body class="fn-bg-white">
    ...
    <section class="py-6 lg:py-8">
        <div class="max-w-7xl mx-auto px-4 lg:px-6">
            <form action="<?php echo e(route('home')); ?>" method="GET" class="max-w-5xl mx-auto">
        ...
        <div class="mx-auto max-w-[1650px] px-4 lg:px-6">
            <div class="mb-8">
                ...
                <p class="mt-2 text-sm text-slate-500">
                    <span class="font-semibold text-slate-900"><?php echo e($featuredListings->count()); ?></span>
                    <?php echo e($featuredListings->count() === 1 ? 'property' : 'properties'); ?> available
                </p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-x-8 gap-y-12 items-start">
                <?php $__empty_1 = true; $__currentLoopData = $featuredListings->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <a href="<?php echo e(route('listings.show', $property)); ?>" class="listing-card">
                        <div class="listing-image-wrap aspect-[4/3] mb-3">
                            ...
                            <div class="absolute inset-x-0 top-0 flex items-start justify-between gap-3 p-3">
                                ...
                                <?php else: ?>
                                    <span class="listing-chip bg-white/92 text-slate-800 shadow-sm"><?php echo e($property->rental_mode === 'per_room' ? 'Room choice' : 'Whole place'); ?></span>
                                <?php endif; ?>
                        ...
                        <div class="listing-details">
                            <div class="flex items-start justify-between gap-3">
                                <h3 class="text-[15px] font-semibold text-slate-950 leading-6 line-clamp-1"><?php echo e($property->title); ?></h3>
                    ...
                    <div class="flex flex-col items-start justify-center p-7 text-left sm:p-8 lg:p-12">
                        ...
                        <div class="mt-8">
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(url('/roommates/profile')); ?>" class="inline-flex items-center justify-center rounded-2xl bg-rose-500 px-6 py-3 text-sm font-semibold text-white shadow-[0_12px_24px_rgba(255,56,92,0.22)] transition hover:-translate-y-0.5 hover:bg-rose-600">Start Matching Now</a>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center rounded-2xl bg-rose-500 px-6 py-3 text-sm font-semibold text-white shadow-[0_12px_24px_rgba(255,56,92,0.22)] transition hover:-translate-y-0.5 hover:bg-rose-600">Start Matching Now</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr]">
                    <div class="p-8 text-left sm:p-10 lg:p-12">
                        ...
                        <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                            <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center rounded-2xl bg-rose-500 px-7 py-3 text-sm font-semibold text-white shadow-[0_12px_24px_rgba(255,56,92,0.22)] transition hover:-translate-y-0.5 hover:bg-rose-600">Create Free Account</a>
                            <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-7 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-300 hover:bg-slate-50">Sign In</a>
                        </div>
                    </div>
    ...
    <script>
        ...
        function showGuestSavePrompt() {
            ...
            toast.innerHTML = `
                ...
                <a href="<?php echo e(route('register')); ?>" style="display:inline-flex; margin-top:10px; color:#fff; font-weight:600; text-decoration:underline;">Sign up</a>
            `;
            toast.style.cssText = `
                position: fixed;
                right: 20px;
...
<?php /**PATH C:\xampp\htdocs\FindNest\resources\views/welcome.blade.php ENDPATH**/ ?>