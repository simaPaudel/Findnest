...
<div class="fn-property-map-shell">
    <?php if($title || $helpText): ?>
        <div class="fn-property-map-copy">
            <?php if($title): ?>
                <h3 class="fn-property-map-title"><?php echo e($title); ?></h3>
            <?php endif; ?>
            <?php if($helpText): ?>
                <p class="fn-property-map-help"><?php echo e($helpText); ?></p>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <div class="fn-property-map-stage">
        <div
            ...
            data-latitude-input="<?php echo e($latitudeInputId); ?>"
            data-longitude-input="<?php echo e($longitudeInputId); ?>"
            data-initial-latitude="<?php echo e($initialLatitude); ?>"
            data-initial-longitude="<?php echo e($initialLongitude); ?>"
            data-default-latitude="<?php echo e($defaultLatitude); ?>"
            data-default-longitude="<?php echo e($defaultLongitude); ?>"
            data-default-zoom="<?php echo e($defaultZoom); ?>"
...
<script>
    (function () {
        const mapEl = document.getElementById(<?php echo json_encode($mapId, 15, 512) ?>);
...
<?php /**PATH C:\xampp\htdocs\FindNest\resources\views/components/leaflet-property-map.blade.php ENDPATH**/ ?>